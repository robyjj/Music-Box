...
$('#select_letter').closest('.ui-select').addClass('select_letter');
var startingLetters =[];
...
function destroySelectSong()
{
  $("#divSelectSong").empty();
  $("#divSelectSong").html("<select name=\"select_song\" id=\"select_song\" class=\"select_song\"></select>");
}
